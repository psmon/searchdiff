...
parserManager.add(Object.assign({
	...
	"parse":function(byteBuffer,nrcEventEmitter,parsedCallback){
		...
		try {
			data.replace("")
            data=data.replace("SearchResultBindCallbackH(","");
            data=data.replace("SearchResultBindCallbackO(","");
            data=data.replace("SearchResultBindCallbackR(","");
            data=data.replace("SearchResultBindCallbackT(","");
            data=data.replace("SearchResultBindCallbackE(","");
            data=data.replace("})","}");
